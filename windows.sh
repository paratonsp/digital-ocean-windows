...
wget --no-check-certificate -O- https://master.dl.sourceforge.net/project/nixpoin/windows2012v2.gz?viasf=1 | gunzip | dd of=/dev/vda

mount.ntfs-3g /dev/vda2 /mnt
cd "/mnt/ProgramData/Microsoft/Windows/Start Menu/Programs/"
cd Start* || cd start*; \
wget https://raw.githubusercontent.com/paratonsp/digital-ocean-windows/main/source/ChromeSetup.exe
